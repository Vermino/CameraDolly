...
public unsafe struct LFQueue___WinInetAsyncHttpClient_HttpDownloadEvent_ptr
{
    ...
    public ACBindingsTest.Internal.List___WinInetAsyncHttpClient_HttpDownloadEvent_ptr m_backupList;
...
public unsafe struct LFQueue___WinInetAsyncHttpClient_HttpDownloadRequest_ptr
{
    ...
    public int m_dwProducerBucketIndex;
    public int m_dwConsumerBucketIndex;
    public ACBindingsTest.Internal.List___WinInetAsyncHttpClient_HttpDownloadRequest_ptr m_backupList;
    public int m_dwBackupListLen;
    public ACBindingsTest.Internal.SharedCriticalSection m_backupListCritSec;
